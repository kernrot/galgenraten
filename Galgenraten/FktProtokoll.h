...
struct WProtokoll hinzuWProtokoll(struct WProtokoll **WoerterProtokoll, struct TProtokoll **anzuhaengendesTippProtokoll, int debug);	// ein TippProtokoll zum WortProtokoll hinzufügen, gibt das hinzugefügte zurück
